...
## Documentation (max 1 mark)
  ...
  Feedback: The crc cards and the readme are not updated
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    Your mark: 6 / 8. Feedback: Two bugs occured during demo, one for duplicating a booking and another for not updating profile pictures. 
