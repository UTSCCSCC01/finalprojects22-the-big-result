...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 2 Feedback: Classes are not updated. Some classes don't have the responsibilities defined in detail (i.e. Customer, Settings, Service, etc.)
...
## Documentation (max 1 mark)
  ...
  Your Mark: 0 / 1 Feedback: Need to be updated for each sprint
